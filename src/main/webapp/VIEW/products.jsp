        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading">
                    <h2>Những sản phẩm loại: ${type}</h2>
                    <span>Tất các những sản phẩm cửa hàng đang có</span>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="item">
                        <div class="thumb">
                            <div class="hover-content">
                                <ul>
                                    <li><a href="chi-tiet-san-pham?id=${product.id}&quantity=1"><i class="fa fa-eye"></i></a></li>
                                </ul>
                            </div>
                            <img src="${pageContext.request.contextPath}/VIEW/assets/images/${product.image}" alt="">
                        </div>
                    ...
                    <ul>
                        <c:forEach begin="1" end="${noPage}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li>
                                        <a href="danh-sach-san-pham?type=${param.type}&page=${i}">${i}</a>
                                    </li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        <li>
                            <a href="danh-sach-san-pham?type=${param.type}&page=${param.page+1}">></a>
                        </li>
                    </ul>
                </div>
            </div>
